...
var node_sqlparser_1 = require("node-sqlparser");
...
var FireSQL = /** @class */ (function () {
    function FireSQL(refOrOptions, options) {
        ...
        if (typeof refOrOptions === 'object') {
            if (refOrOptions instanceof app_1.default.firestore.DocumentReference) {
                this._ref = refOrOptions;
            }
            else if (refOrOptions instanceof app_1.default.firestore.Firestore) {
    ...
    FireSQL.prototype.query = function (sql, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                utils_1.assert(typeof sql === 'string' && sql.length > 0, 'query() expects a non-empty string.');
                ast = node_sqlparser_1.parse(sql);
                if (ast.type === 'select') {
                    return [2 /*return*/, select_1.select_(this._getRef(), ast, __assign({}, this._options, options))];
                }
                else {
    ...
    FireSQL.prototype._getRef = function () {
        if (!this._ref) {
            try {
                var firestore = app_1.default.firestore();
...
exports.FirestoreSQL = FirestoreSQL;
